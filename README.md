...
這個專案用 TypeScript、Azure Functions 與 MongoDB 建立「台灣主動式 ETF Intelligence Platform」。目前 production sync 追蹤已驗證來源的股票型主動 ETF：統一投信 `00981A`、`00988A`、`00403A`、野村投信 `00980A`、`00985A`、`00999A`、群益投信 `00997A`、`00982A`、`00992A`、元大投信 `00990A`、中信投信 `00995A`、`00983A`、`00406A`、富邦投信 `00405A`、台新投信 `00986A`、`00987A`、國泰投信 `00400A`、安聯投信 `00984A`、`00993A`、`00402A`、聯博投信 `00404A`、兆豐投信 `00996A`、摩根投信 `00989A`、`00401A`、復華投信 `00991A`、`00409A`、第一金投信 `00994A`、`00408A`、凱基投信 `00407A`，以及永豐投信 `00410A`。富邦投信 `00982D`、`00983D` 與聯博投信 `00984D` 的債券型 provider 已完成驗證，但目前保持 disabled，避免混入股票型排名與頁面。
