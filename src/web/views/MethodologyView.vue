...
const sections = [
  ...
  { title: "拉力與推力觀察", fact: "拉力區使用目前可取得的產業、題材分類與同日市場反應；推力區使用 ETF 持股變化與投信買賣超。", calculation: "ETF 端只使用基金規模校正後的主動淨變動，再與投信當日方向分開呈現；計算層保留原始股數，台股畫面依 1 張 = 1,000 股換算成張，海外持股維持股數。", limit: "拉力線索與資金推力是分項觀察，不等於完整評分或交易結論。" },
