...
<template>
  <main class="app-shell p0-shell">
    ...
    <footer class="p0-footer">
      ...
      <span><a href="/zh-TW/mcp">會員 MCP / Skill</a><a href="/methodology" @pointerenter="prefetchRouteComponent('/methodology')" @focus="prefetchRouteComponent('/methodology')" @click.prevent="navigate('/methodology')">方法論</a><a href="/active-etfs/">追蹤 ETF 清單</a><a href="/data-usage/">資料來源與使用說明</a><a href="/privacy" @pointerenter="prefetchRouteComponent('/privacy')" @focus="prefetchRouteComponent('/privacy')" @click.prevent="navigate('/privacy')">隱私政策</a><a href="/terms" @pointerenter="prefetchRouteComponent('/terms')" @focus="prefetchRouteComponent('/terms')" @click.prevent="navigate('/terms')">服務條款</a><button type="button" data-tracking-consent-ui @click="trackingConsent?.open()">追蹤設定</button></span>
    </footer>
