...
import { BookOpen, ChevronDown, LogIn, LogOut, Plug, UserRound } from "@lucide/vue";
  ...
  <div ref="root" class="auth-menu">
    ...
    <template v-else>
      ...
      <div v-if="isOpen" class="auth-dropdown" role="menu">
        ...
        <a role="menuitem" href="https://active-etf-mcp.inthewins.com/zh-TW/mcp/connect" @click="isOpen = false"><Plug :size="16" />會員 MCP 與用量</a>
        <a role="menuitem" href="https://active-etf-mcp.inthewins.com/zh-TW/mcp/skill" @click="isOpen = false"><BookOpen :size="16" />Skill 安裝說明</a>
