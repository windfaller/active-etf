...
const en = {
  ...
  endpoint: "MCP server URL",
    testEndpoint: "Test MCP URL · not the production address",
  copy: "Copy",
  copied: "Copied",
...
export const agentCopy: Record<AgentLocale, AgentCopy> = {
  ...
  "zh-TW": {
    ...
    endpoint: "MCP 伺服器網址",
    testEndpoint: "測試 MCP 網址・非正式連接位址",
    copy: "複製",
    copied: "已複製",
  ...
  "zh-CN": {
    ...
    endpoint: "MCP 服务器地址",
    testEndpoint: "测试 MCP 地址・非正式连接地址",
    copy: "复制",
    copied: "已复制",
  ...
  ja: {
    ...
    testEndpoint: "テスト用 MCP URL・本番接続先ではありません",
    copy: "コピー",
    copied: "コピーしました",
  ...
  ko: {
    ...
    endpoint: "MCP 서버 URL",
    testEndpoint: "테스트 MCP URL · 정식 연결 주소가 아닙니다",
    copy: "복사",
    copied: "복사됨",
